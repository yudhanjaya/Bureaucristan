"""
From 
https://github.com/InstaPy/instapy-quickstart/blob/master/quickstart_templates/target_followers_of_similar_accounts_and_influencers.py
Also see: https://github.com/timgrossmann/InstaPy
"""
